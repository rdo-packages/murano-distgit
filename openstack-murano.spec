...
%changelog
* Wed Feb 28 2018 RDO <dev@lists.rdoproject.org> 5.0.0-1
- Update to 5.0.0

* Thu Feb 22 2018 RDO <dev@lists.rdoproject.org> 5.0.0-0.2.0rc1
- Update to 5.0.0.0rc2

* Mon Feb 19 2018 RDO <dev@lists.rdoproject.org> 5.0.0-0.1.0rc1
